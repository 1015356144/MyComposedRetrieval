...
def construct_prompt(reference_image_path, hard_negative_image_path, modification_text):
    tem_prompt = f"""
    You are a multimodal edit auditor. You receive TWO images (FIRST = REFERENCE, SECOND = TARGET) and ONE input edit text.
    ...
    -Image roles: The FIRST image is REFERENCE (original), the SECOND image is TARGET (to match).
    - Grounding:
    ...
    - Reference: [REFERENCE] 2–4 literal sentences. Be thorough and accurate; list visible objects, attributes (color/material), counts, spatial relations, and readable text. Do not mention TARGET here. If unreadable, say “uncertain”.
    - Target: [TARGET] 2–4 literal sentences. Same constraints; do not mention REFERENCE here.
...
### FEWSHOT EXAMPLE (CONTEXT ONLY — DO NOT COPY INTO OUTPUT)
##Example 1   
<Input>
