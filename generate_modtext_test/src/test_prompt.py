...
def generate_response(model, processor, reference_image_path, hard_negative_image_path, modification_text, base_path, user_prompt: str = ""):
    ...
    try:
        ...
        - Output exactly these 5 sections(stages), in this order, with the exact section headers shown below.
        ...
        - Responses include the Decompose Intents, Generate Polar Questions, Answer Questions via Image Comparison, Local Edits, and Generate Text_new:
