...
# 输出信息
echo "启动Qwen2-VL-7B分解重排序任务..."
echo "日志将保存到: $LOG_FILE"

# 后台运行命令并将输出重定向到日志文件
nohup accelerate launch --num_processes 8 VQA_rerank_decomposed.py \
    ...
    --output_file /home/guohaiyun/yangtianyu/MyComposedRetrieval/VQA_rerank/results/qwen2_7b/R1_49/7Btext_decomposed_reranked_results.json \
    --batch_size 2 \
    --max_image_size 2048 \
